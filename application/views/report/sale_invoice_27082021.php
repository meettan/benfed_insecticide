...
<!-- <div class="col-sm-2 logo_sec_main">
  ...
  <!-- <tr><td id="qr_gen"><img src="<?php //$qr; ?>" class="pull-right" alt=""></td></tr>
    ...
    <tr> -->
        <td align="left" valign="top" class="border_bottom border_top"><table width="100%" cellpadding="0" cellspacing="0" class="table tableCus table2">
    <tr>
<td scope="col" class="tax_1 padding_botNew"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="table3">
        <tbody>
          <tr>
...
<!-- <h2 style="text-align:center">The West Bengal State Co-operative Marketing Federation Ltd.</h2>
  <h4 style="text-align:center">Southend Conclave, 3rd Floor,1582 Rajdanga Main Road,Kolkata - 700 107.</h4> -->
    ...
    <tr>
      <td align="left" valign="top"><table width="100%" cellpadding="0" cellspacing="0" class="table tableCus table5">
        <thead>
          <tr>
            ...
            <td scope="col" class="col_13_5 titleTd border_bottom">Rate</td>
			 ...
			 <td scope="col" class="col_13_6 titleTd border_bottom">Per</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table6">
			    <tbody>
			      <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table8">
			    <tbody>
			      <tr>
			      ...
			      <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table9">
			          <tbody>
			            <tr>
			              <td width="50%" class="col_50Per">Rate</td>
			              <td class="col_50Per">Amount</td>
		...
		<td align="left" valign="top" class="border_right">&nbsp;</td>
          ...
          <tr>
            ...
            <td align="left" valign="top" class="border_right">&nbsp;</td>
			  <td align="left" valign="top" class="border_right"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="table10">
			    <tbody>
			      <tr>
                ...
                <td align="left" valign="top" class="border_right"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="table11">
                  <tbody>
                    <tr>
                      <td width="50%" class="col_50Per"><?php echo  $data->gst_rt/2;?>%</td>
                      <td class="col_50Per"><?php echo  $data->cgst;?></td>
          ...
          <tr>
            ...
            <td align="left" valign="top" class="border_right border_bottom">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table12">
              <tbody>
                <tr>
            ...
            <td align="left" valign="top" class="border_right border_bottom">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table13">
              <tbody>
                <tr>
                  <td width="50%" class="col_50Per">&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table14">
  <tbody>
    <tr>
<td class="tax_1"><table width="100%" cellpadding="0" cellspacing="0" class="table tableCus table15">
        <thead>
          <tr>
          <td scope="col" class="col_12_1 titleTd border_bottom"></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table15">
              <tbody>
                <tr>
                  <td style=" border: none !important;"><strong>CGST</strong></td>
                </tr>
                <tr>
                  <td style="margin: 0;  border-right: none !important;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table16">
                    <tbody>
                      <tr>
                        <td width="50%" class="col_50Per">Rate</td>
                        <td class="col_50Per">Amount</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table17">
              <tbody>
                <tr>
                  <td style=" border: none !important;"><strong>SGST</strong></td>
                </tr>
                <tr>
                  <td style="margin: 0;  border-right: none !important;">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table18">
                    <tbody>
                      <tr>
                        <td width="50%" class="col_50Per">Rate</td>
                        <td class="col_50Per">Amount</td>
        ...
        <tbody>
          ...
          <td align="left" valign="top"></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table19">
              <tbody>
                <tr>
                  <td width="50%" class="col_50Per"><?php echo  $data->gst_rt/2;?></td>
            ...
            <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table20">
              <tbody>
                <tr>
                  <td width="50%" class="col_50Per"><?php echo  $data->gst_rt/2;?></td>
                  <td class="col_50Per"><?php echo  $sum_data->sgst;?></td>
          ...
          <td align="right" valign="top"><strong>Total:</strong></td>
            <td align="left" valign="top"><?php echo  $sum_data->taxable_amt;?></td>
            <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table21">
              <tbody>
                <tr>
                  <td width="50%" class="col_50Per">&nbsp;</td>
                  <td class="col_50Per"><?php echo  $sum_data->cgst;?></td>
  ...
  <tbody>
    ...
    <tr>
      <td class="formDurkBack border_bottom border_top"><p style="padding: 0; margin: 0; float: left">Tax Amount(in words)INR <?php echo getIndianCurrency($sum_data->tot_gst);?></p></td>
      <td class="formDurkBack border_bottom border_top" align="right">Total: <strong><?php echo  $data->tot_amt;?></strong></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table23">
  <tbody>
...
//   var settings = {
//     "url": "https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=rajasaha.ocp@gmail.com,01/08/2020",
//     "method": "POST",
//     "timeout": 0,
//   };
