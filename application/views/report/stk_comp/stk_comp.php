            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Companywise Stock Report Between: <?php echo date("d/m/Y", strtotime($date[0]))." - ".date("d/m/Y", strtotime($date[1]))?></h4>
                        <h5 style="text-align:left"><label>District: </label> <?php echo $branch->district_name; ?></h5>
                        <h5 style="text-align:left"><label>Company: </label> <?php foreach ($stock as $stockkey) {echo $stockkey->comp_name; break;}?></h5>
