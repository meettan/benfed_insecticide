        ...
        <form method="POST" id="form" action="<?php echo site_url("fert/rep/purrepbr");?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <select name="comid" class="form-control sch_cd required" id="comid" required>
                        ...
                        <?php
                            ...
                            foreach($all_company as $alcp){

                                
                        ?>

                        <option value="<?php echo $alcp->COMP_ID;?>"><?php echo $alcp->COMP_NAME;?></option>
