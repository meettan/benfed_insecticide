...
tr:hover {background-color: #f5f5f5;}
    ...
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
                 ...
                 <form method="POST" id="form" action="<?php echo site_url("fert/rep/crnoterep_ho");?>" >
                <div class="form-header">
                
                    <h4> Date Range & Company</h4>
                ...
                <div class="col-sm-6">
                    ...
                    <select name="comp" class="form-control sch_cd required" id="comp" required>
